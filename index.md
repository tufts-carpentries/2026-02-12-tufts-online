...
humandate: "February 12, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am - 3:00pm"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 20260212      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 20260212        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Sarah Corvene", "Elizabeth McCall"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Annie Colby-McKeon", "Sean Corning", "Anna Milyaeva", "Allie Tatarian"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["katherine.morley@tufts.edu","sarah.corvene@tufts.edu", "elizabeth.mccall@tufts.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2026-02-12-tufts-online # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
